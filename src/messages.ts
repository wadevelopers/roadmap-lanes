const STRINGS = {
	en: {
		...
		parts: "Parts",
		partOf: "Part of",
		openInObsidian: "Open note in Obsidian",
		...
		"alert_missing-frontmatter": "{file}: missing frontmatter",
		"alert_empty-relation-field": "{id}: relation field '{field}' is declared empty",
	...
	es: {
		...
		reloadBoard: "Recargar tablero",
		clearSearch: "Limpiar búsqueda",
		clearSearchButton: "Limpiar",
		...
		parts: "Partes",
		partOf: "Parte de",
		openInObsidian: "Abrir nota en Obsidian",
		...
		"alert_missing-frontmatter": "{file}: falta frontmatter",
		"alert_empty-relation-field": "{id}: campo de relación '{field}' declarado vacío",
		"alert_maturity-not-ready-on-next":
...
export function createTranslatorForLanguage(language = "en"): Translator {
	const table = language.toLowerCase().startsWith("es") ? STRINGS.es : STRINGS.en;
	return (key) => table[key] ?? STRINGS.en[key];
}

export function formatAlert(alert: { code: string; params?: Record<string, unknown> }, t: Translator): string {
